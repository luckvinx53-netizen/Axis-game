  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-stadium-glow">
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-24">
        ...
        <div className="mt-16 flex items-center gap-3 border-t border-pitch-700 pt-6 text-sm text-ink-500">
          <span className="h-2 w-2 rounded-full bg-signal-500" />
          Estrutura do projeto pronta — Next.js + Supabase + Vercel.
        </div>
      </div>
    </main>
  );
